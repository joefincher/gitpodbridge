...
class LanguageSuggestionSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['debug'] = [
      ...
      '#description' => $this->t('See recent logs for debugging messages.'),
    ...
    $form['language_detection'] = [
      ...
      '#options' => [
        ...
        '_server' => $this->t('$_SERVER variable'),
      ],
      '#states' => [
        'visible' => [
          ':input[name="enabled"]' => ['checked' => TRUE],
    ...
    $form['_server_parameter'] = [
      '#type' => 'textfield',
      '#title' => $this->t('$_SERVER variable name'),
      '#description' => $this->t('Specify variable name that contains country code. e.g. HTTP_X_GEO_COUNTRY_CODE.'),
      '#default_value' => $config->get('_server_parameter'),
      '#states' => [
        'visible' => [
          ':input[name="enabled"]' => ['checked' => TRUE],
          ':input[name="always_redirect"]' => ['checked' => TRUE],
          ':input[name="language_detection"]' => ['value' => '_server'],
        ],
      ],
    ];
    $form['geoip_db_file'] = [
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('language_suggestion.settings')
      ...
      ->set('_server_parameter', $form_state->getValue('_server_parameter'))
